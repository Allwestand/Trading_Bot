...
class TradingBot: 
    ...
    def _build_model(self, hu, lr, dropout):
        ...
        self.learn_env.lags, self.learn_env.n_features),activation='relu')) 
        if dropout:
        ...
        model.compile(loss='mse',  optimizer=keras.optimizers.legacy.RMSprop(learning_rate=lr))
        return model
    def act(self, state):
    ...
    def learn(self, episodes):
        ...
        for e in range(1, episodes + 1):
            ...
            for _ in range(10000):
                ...
                next_state = np.reshape(next_state,[1, self.learn_env.lags
                                                ,self.learn_env.n_features])
